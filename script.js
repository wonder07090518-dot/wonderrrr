...
Object.assign(zhToEn, {
  ...
  '/ 张':'/ image','/ 页':'/ slide','/ 个':'/ mark','/ 月':'/ month','/ 年':'/ year','小红书':'Xiaohongshu','一句文案、一张参考图，或只是一个模糊的感觉。':'One line of copy, one reference image, or simply a rough feeling.','微信或支付宝付款，邮箱同步确认订单与进度。':'Pay by WeChat or Alipay and receive order updates by email.','AI 生成加人工精选，把好看的那一版交给你。':'AI generation with human curation, delivered in its best final form.','选择项目、写下需求，提交后会发送确认邮件与付款指引。':'Choose a service, share your brief, then receive an email confirmation and payment instructions.','提交后显示“正在审核中”，付款二维码将发送至你的邮箱。':'Your order will be under review and a payment QR code will be emailed to you.','创意服务上线':'Creative services launch','付款与交付':'Payment and delivery','账户与双语':'Account and bilingual mode','广告海报示例':'Advertising poster example'
});
