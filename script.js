...
const servicePrices = {
  '社媒封面': '¥4 / 张', '营销海报': '¥4 / 张', '电商商品图': '¥4 / 张', 'PPT 美化': '¥7.5 / 页', 'AI 快速配图': '¥0.3 / 张', '品牌 Logo': '¥11.5 / 个', 'Banner 设计': '¥3 / 张', 'AI 简历照片': '¥1 / 张', 'AI 证件照': '¥1 / 张', 'AI 去背景': '¥0.3 / 张', '创意字贴': '¥3 / 张', '壁纸设计': '¥4 / 张', '短视频剪辑': '¥15 / 条起', '音频配乐': '¥5 / 条起',
  'Social cover': '¥4 / image', 'Marketing poster': '¥4 / image', 'E-commerce visual': '¥4 / image', 'Slide design': '¥7.5 / slide', 'AI quick image': '¥0.3 / image', 'Brand logo': '¥11.5 / mark', 'Banner design': '¥3 / image', 'AI resume photo': '¥1 / image', 'AI ID photo': '¥1 / image', 'AI background removal': '¥0.3 / image', 'Creative type sticker': '¥3 / image', 'Wallpaper design': '¥4 / image', 'Short video edit': '¥15 / video', 'Audio edit': '¥5 / track'
};
const zhToEn = {
...
Object.assign(zhToEn, {
  '01 / 社媒':'01 / Social','02 / 海报':'02 / Poster','03 / 电商':'03 / Commerce','04 / PPT':'04 / Slides','05 / 图片':'05 / Image','06 / 品牌':'06 / Brand','07 / 横幅':'07 / Banner','08 / 职场':'08 / Career','09 / 证件':'09 / ID photo','10 / 工具':'10 / Tool','11 / 字贴':'11 / Type','12 / 壁纸':'12 / Wallpaper','13 / 视频':'13 / Video','14 / 音频':'14 / Audio',
...
Object.assign(zhToEn, {
  '短视频剪辑': 'Short video edit', '宣传短片、商品视频、社媒 Reels': 'Promos, product videos and social reels', '把画面、节奏和字幕一起做好。': 'Bring together visuals, pacing and captions.',
  '音频配乐': 'Audio edit', '广告配乐、旁白剪辑、短音频包装': 'Ad music, voice edits and short audio packaging', '让内容听起来更完整。': 'Make the content sound complete.', '/ 条起': '/ item from'
});
...
document.querySelector('#orderForm').addEventListener('submit', async event => {
  ...
  const order = { id: `WA${Date.now().toString().slice(-7)}`, service: service.value, price: servicePrices[service.value] || '待确认报价', email: document.querySelector('#customerEmail').value.trim(), idea: form.querySelector('textarea').value.trim(), size: form.querySelector('input[name="size"]:checked').value, style: form.querySelector('input[name="style"]:checked').value, payment, status: '审核中', date: formatDate() };
...
function answerSupport(question) {
  ...
  if (/视频|video|reel|剪辑/.test(text)) return english ? 'Short video editing starts at ¥15 per video. Tell us the platform, duration, footage and subtitle style in your brief.' : '短视频剪辑 ¥15 / 条起。下单时写上发布平台、时长、素材情况和字幕风格即可。';
  if (/音频|音乐|配乐|audio|music|voice/.test(text)) return english ? 'Audio edits and simple music packaging start at ¥5 per track. Include duration, mood and any voice-over requirements.' : '音频配乐 ¥5 / 条起。下单时写上时长、氛围和是否需要旁白剪辑。';
