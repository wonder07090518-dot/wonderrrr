...
function renderMethod() { document.querySelectorAll('[data-method]').forEach(button => button.classList.toggle('active', button.dataset.method === method)); qr.src = method === '支付宝' ? 'public/payment/alipay.jpg' : 'public/payment/wechat.jpg'; qr.alt = `${method}收款码`; hint.textContent = `请使用${method}扫码付款`; }
